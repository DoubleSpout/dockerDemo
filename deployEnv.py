...
PERCONA_URL = 'http://www.percona.com/redir/downloads/Percona-Server-5.6/LATEST/source/tarball/percona-server-5.6.21-70.0.tar.gz'
...
streamObj = subprocess.call(['ln -s {0}/python /usr/local/bin/python27'.format(softwarePath)],cwd=INSTALL_PATH, shell=True)
